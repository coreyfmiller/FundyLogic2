...
function CTA() {
  return (
    <section id="contact" className="py-24 md:py-32 border-t border-[#1f1f2e]">
      <div className="max-w-3xl mx-auto px-4 text-center">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
          <motion.h2 variants={fadeUp} className="text-3xl sm:text-4xl font-bold text-white mb-4">Ready to put AI to work?</motion.h2>
          <motion.p variants={fadeUp} className="text-gray-400 mb-10">Book a free 15-minute call. We will tell you exactly what an AI agent could do for your business.</motion.p>
          <motion.div variants={fadeUp}>
            <a href="mailto:info@fundylogic.com" className="inline-flex items-center gap-2 px-8 py-4 rounded-lg bg-[#00d4ff] text-black font-bold text-lg hover:bg-[#00b8e6] transition shadow-lg shadow-[#00d4ff]/20">
              Book a Discovery Call <ArrowRight className="w-5 h-5" />
            </a>
            <p className="mt-4 text-sm text-gray-500">info@fundylogic.com</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
